...
| **Admin only optout**                               |        |                                                                                                  |
| ```/preferences-admin/optout/:entityId```           | `POST` | Manual opt-out                                                                                   |
...
> #### 2.2.10.1 ```POST /preferences-admin/:entityId/optout```
>  Used for opting out manually via preference admin frontend
